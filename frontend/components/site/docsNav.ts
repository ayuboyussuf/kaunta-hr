  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        summary: "Unannounced mid-shift re-scans — how the times are drawn and what a miss means.",
        keywords: [
          "presence",
          "random check",
          "mid-shift",
      ...
      },
      {
        ...
        summary: "Notice periods, half-days, paid or unpaid, and what an approved day settles.",
        keywords: [
          "leave",
          "time off",
          "holiday",
      ...
      },
      {
        ...
        keywords: ["dispute", "appeal", "waive", "uphold", "pdf", "locked", "outcome", "assist", "brief"],
      },
      {
        href: "/docs/payslips",
