  ...
  return (
    <main className="min-h-screen grid place-items-center bg-aproksi-stone px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-aproksi-slate/70 text-sm mb-8">Owner sign in</p>
        ...
        <p className="text-sm text-aproksi-slate/70 mt-6">
          New here?{" "}
          <Link href="/signup" className="text-aproksi-ultra hover:underline">
            Create an owner account
          </Link>
        </p>
        <p className="text-sm text-aproksi-slate/70 mt-2">
          Employee?{" "}
          <Link href="/me/login" className="text-aproksi-ultra hover:underline">
